    ...
    >
      ...
      <div data-services-heading>
        ...
        <h2
          ...
          className="mt-3 text-3xl font-black tracking-tight text-[#2A0659] md:text-4xl"
        >
          Services designed for high-stakes communication
        </h2>
        <p className="mt-4 text-sm leading-relaxed text-[#2A0659]/70 md:text-base">
        ...
        {services.map((service, index) => (
          ...
          >
            ...
            <div className="p-5 pb-4 md:p-5 md:pb-4">
              <p className="text-[0.68rem] font-semibold uppercase tracking-[0.2em] text-[#7A21C8]">
                Service {String(index + 1).padStart(2, "0")}
              </p>

              <h3 className="mt-3 text-3xl font-black leading-tight tracking-tight text-[#23044B] md:text-[2rem]">
                <span className="block whitespace-nowrap text-[1.35rem] leading-none md:text-[1.5rem]">
                  {service.title}
                </span>
              </h3>

              <p className="mt-3 max-w-[34ch] text-[1rem] leading-relaxed text-[#2A0659]/72">
                {service.description}
              </p>
            </div>
          </Card>
